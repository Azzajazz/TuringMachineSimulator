...
class Window(tk.Tk):
  ...
  def build_description_frame(self, parent):
    ...
    self.alpha_label = tk.Label(description_frame, text="Alphabet = {a, b}", justify="left")
    ...
    self.state_label = tk.Label(description_frame, text="Q = {q0, q1}", justify="left")
    ...
    self.delta_label_1 = tk.Label(description_frame, text="delta(q0, a) = (q1, a, L)", justify="left")
    self.delta_label_1.grid(row=4, column=0, sticky="w")
    self.delta_label_2 = tk.Label(description_frame, text="delta(q1, b) = (q0, a, L)", justify="left")
